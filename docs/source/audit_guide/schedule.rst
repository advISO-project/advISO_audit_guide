...
.. card:: 🧬 The Pathogen X Analysis Pipeline
   ...
   **Process**: The bioinformatics analysis pipeline used for Pathogen X, which processes raw sequence data to generate a final report on drug resistance which is delivered to clinicians. 
