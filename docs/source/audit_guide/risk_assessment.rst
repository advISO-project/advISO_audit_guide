...
Priority should be given to auditing high-risk areas first, as these are the areas that are most likely to impact patient care and safety. Low-risk areas can be audited less frequently or with less depth, as they are less likely to impact patient care and safety.
